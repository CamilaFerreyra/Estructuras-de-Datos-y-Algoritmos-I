...
typedef struct _AVL_Nodo {
  ...
  int altura; //la altura del arbol vacio es -1
} AVL_Nodo;
...
static AVL_Nodo* avl_nodo_rotacion_simple_der(AVL_Nodo* raiz) {
  ...
  hijoIzq->der = raiz;
  //actualizo alturas. es importante primero actualizar alturas de hijos y luego de padres.
  raiz = avl_nodo_max_altura_hijos(raiz) + 1;
  hijoIzq = avl_nodo_max_altura_hijos(hijoIzq) + 1;
