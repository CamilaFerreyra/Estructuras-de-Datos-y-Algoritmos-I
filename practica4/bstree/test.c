...
int main() {
  ...
  bstree_eliminar(arbol, "arbol", comparar_cadena, destruir_cadena);
  bstree_eliminar(arbol, "unr", comparar_cadena, destruir_cadena);
  bstree_eliminar(arbol, "calle", comparar_cadena, destruir_cadena);
